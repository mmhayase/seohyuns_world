...
class ControllersControllerTest < ActionController::TestCase
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post :create, controller: { active: @controller.active, article: @controller.article, category_id: @controller.category_id, content: @controller.content, title: @controller.title }
    end
  ...
  test "should update controller" do
    patch :update, id: @controller, controller: { active: @controller.active, article: @controller.article, category_id: @controller.category_id, content: @controller.content, title: @controller.title }
    assert_redirected_to controller_path(assigns(:controller))
  end
